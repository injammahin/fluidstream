...
@section('content')
  <style>
    ...
    * {
    ...
    .hero-patent-callout {
      ...
      background: linear-gradient(180deg, rgba(245, 249, 255, 0.96), rgba(236, 243, 252, 0.96));
    ...
    .hero-patent-callout-text .hero-patent-link {
      color: #0018dc;
      font-weight: 800;
    }
      ...
      <div>
        ...
        <div class="hero-patent-callout">
          <p class="hero-patent-callout-text">
            <strong>Patented operating methods.</strong>
            Fluidstream’s liquid-influenced compression response is supported by patented operating methods,
            including <span class="hero-patent-link">US11098709B2</span>.
          </p>
        </div>
  ...
  <style>
    ...
    .section-patent-callout-text strong {
      color: #0b1e4b;
      font-weight: 800;
    }
    ...
    <div class="container content-pad">
      <div class="split">
        <div>
          ...
          <div class="section-patent-callout section-patent-callout-left">
            <p class="section-patent-callout-text">
              <strong>Patent reference.</strong>
              This liquid-aware operating approach is reinforced by
              <a href="/patented-technology#us11098709b2" class="section-patent-link">US11098709B2</a>,
              which addresses compression behavior when liquid is detected in the chamber.
            </p>
          </div>
        </div>
        ...
        <div class="body-lg">
          <p>
            ...
            creates risk, inefficiency, and reliability issues.
          </p>

          <p>
            Fluidstream systems are designed to operate directly on mixed-phase flow, handling gas, oil, and water
            combinations, high liquid content streams, slugging conditions, and solids entrainment. This enables a shift
            from separation-driven systems to simplified flow-through production systems.
          </p>
        </div>
      </div>
    </div>
  ...
  <style>
    ...
    .system-patent-callout-text strong {
      color: #0b1e4b;
      font-weight: 800;
    }
  ...
  <section class="section soft">
    <div class="container content-pad">
      ...
      <div class="system-patent-callout">
        <p class="system-patent-callout-text">
          <strong>Why this matters technically.</strong>
          Fluidstream’s flow-through path is supported by patented operating methods for responding to liquid-influenced
          compression conditions, including
          <a href="/patented-technology#us11098709b2" class="system-patent-link">US11098709B2</a>.
        </p>
      </div>
      ...
      <div class="compare-grid">
        <div class="compare-card">
          ...
          <p>
            High equipment count, larger footprint, more interconnections, and more potential failure points across the
            facility.
          </p>
        </div>
        ...
        <div class="compare-card highlight">
          ...
          <p>
            Reduced infrastructure, simplified operation, lower cost structure, and broader applicability across
