...
@section('schema')
    @php
        $articleUrl = url('/insights/vapor-recovery-vs-flaring');

        $techArticleSchema = [
            '@context' => 'https://schema.org',
            '@type' => 'TechArticle',
            'headline' => 'Vapor Recovery Unit vs Flaring',
            'alternativeHeadline' => 'Engineering and Economic Guide to Choosing Vapor Recovery Over Flaring',
            'description' => 'A practical engineering and economic guide comparing vapor recovery units and flaring for oil and gas operators, including gas value, emissions exposure, wet vapor reliability, uptime, and Fluidstream VaporCommander applications.',
            'url' => $articleUrl,
            'mainEntityOfPage' => [
                '@type' => 'WebPage',
                '@id' => $articleUrl,
            ...
            'about' => [
                ...
                [
                    '@type' => 'Thing',
                    'name' => 'Oil and gas emissions reduction',
                ],
                [
                    '@type' => 'Thing',
        ...
        $breadcrumbSchema = [
            ...
            'itemListElement' => [
                ...
                [
                    '@type' => 'ListItem',
                    'position' => 3,
                    'name' => 'Vapor Recovery Unit vs Flaring',
                    'item' => $articleUrl,
                ],
            ],
        ];
    ...
    <section class="fs-article-image-hero">
        <style>
            .fs-article-image-hero {
                ...
                color: #ffffff;
                background:
                    linear-gradient(100deg, rgba(2, 8, 35, .36) 0%, rgba(2, 8, 35, .28) 42%, rgba(3, 7, 30, 0.2) 72%, rgba(0, 24, 220, 0) 100%),
        ...
        <div class="fs-article-hero-wrap">
            <div>
                ...
                <p class="fs-article-hero-lede">
                    A practical engineering and economic guide to choosing vapor recovery over flaring or combustion when
                    tank vapors can be captured, compressed, and converted into value instead of destroyed.
                </p>
            ...
            <div class="fs-article-hero-card-stack">
                <div class="fs-article-quote-card">
                    ...
                    <p>
                        When the gas can be captured reliably, operators may reduce emissions exposure, recover saleable
                        gas, and improve facility control instead of burning or venting hydrocarbons.
                    </p>
                </div>
                ...
                <div class="fs-article-mini-grid">
                    <div class="fs-article-mini-card">
                        <b>Gas value</b>
                        <span>Capture hydrocarbons instead of destroying them</span>
                    </div>

                    <div class="fs-article-mini-card">
                        <b>Emissions</b>
                        <span>Reduce venting and combustion exposure</span>
                    </div>

                    <div class="fs-article-mini-card">
                        <b>Wet vapor</b>
                        <span>Designed around real tank vapor conditions</span>
                    </div>

                    <div class="fs-article-mini-card">
                        <b>Reliability</b>
                        <span>Application fit matters more than nameplate capacity</span>
                    </div>
                </div>
            </div>
        </div>
