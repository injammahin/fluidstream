...
@section('content')
    ...
    <section class="hero py-12">
        <div class="wrap hero-grid ">
            <div>
                <div class="eyebrow">Technical Article / Wet Gas VRU Reliability</div>
                ...
                <div class="hero-actions">
                    <a class="btn btn-primary" href="/vaporcommander">Explore VaporCommander™</a>
        ...
        <section class="section section-soft py-12" id="article">
            <div class="wrap article-shell">
                <aside class="toc" aria-label="Article contents">
                    ...
                    <a href="#vaporcommander">How VaporCommander™ differs</a>
                ...
                <article>
                    ...
                    <section class="article-section" id="vaporcommander">
            ...
            <div class="wrap cta-inner">
                <div>
                    ...
                    <div class="cta-actions">
                        ...
                        <a class="btn-1 btn-outline" href="/vaporcommander">Review VaporCommander™</a>
                    </div>
                </div>
                <div class="cta-panel">
