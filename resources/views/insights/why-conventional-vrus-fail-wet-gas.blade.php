...
<section class="fs-article-image-hero">
    <style>
        .fs-article-image-hero {
            ...
            color: #ffffff;
            background:
                linear-gradient(100deg, rgba(2, 8, 35, .36) 0%, rgba(2, 8, 35, .28) 42%, rgba(8, 12, 44, 0.2) 72%, rgba(0, 24, 220, 0) 100%),
    ...
    <div class="fs-article-hero-wrap">
        <div>
            ...
            <p class="fs-article-hero-lede">
                A technical guide to scrubber dependence, liquid carryover, freeze-ups, variable vapor flow, maintenance burden, and why Fluidstream VaporCommander™ is built for wet vapor recovery in real field conditions.
            </p>
        ...
        <div class="fs-article-hero-card-stack">
            <div class="fs-article-quote-card">
                <strong>
                    Many VRUs do not fail because vapor recovery is a bad idea. They fail because the system assumes dry gas when the field delivers wet, variable vapor.
                </strong>

                <p>
                    Tank vapors can carry condensate, water, slugs, and changing flow rates that expose the limits of separator-dependent VRU designs.
                </p>
            </div>
            ...
            <div class="fs-article-mini-grid">
                <div class="fs-article-mini-card">
                    <b>Wet gas</b>
                    <span>Liquids and condensate reach real vapor streams</span>
                </div>

                <div class="fs-article-mini-card">
                    <b>Freeze-ups</b>
                    <span>Scrubbers and drains create winter failure points</span>
                </div>

                <div class="fs-article-mini-card">
                    <b>Low maintenance</b>
                    <span>Case studies prove low-touch reliability</span>
                </div>

                <div class="fs-article-mini-card">
                    <b>Patented logic</b>
                    <span>Liquid-aware compression response</span>
                </div>
            </div>
        </div>
    </div>
