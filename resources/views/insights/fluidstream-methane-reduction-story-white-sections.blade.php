...
@section('schema')
    @php
        $articleUrl = url('/insights/methane-emissions-reduction-oil-gas');

        $techArticleSchema = [
            '@context' => 'https://schema.org',
            '@type' => 'TechArticle',
            'headline' => 'Methane Emissions Reduction Solutions for Oil & Gas',
            'description' => 'A technical guide to methane emissions reduction for oil and gas operators using vapor recovery, low-pressure gas capture, wet gas reliability, and Fluidstream VaporCommander applications.',
            'url' => $articleUrl,
            'mainEntityOfPage' => [
                '@type' => 'WebPage',
                '@id' => $articleUrl,
            ...
            'articleSection' => 'Methane Emissions Reduction',
            'keywords' => [
        ...
        $faqSchema = [
            ...
            'mainEntity' => [
                [
                    '@type' => 'Question',
                    'name' => 'Why is vapor recovery important for methane reduction?',
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text' => 'Vapor recovery can capture low-pressure gas that may otherwise be vented, flared, or combusted, reducing emissions exposure while preserving hydrocarbon value.',
                    ],
                ],
                [
                    '@type' => 'Question',
                    'name' => 'Why do some methane reduction projects underperform?',
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text' => 'Projects often underperform when equipment is selected for ideal dry-gas conditions but the field application includes wet gas, condensate carryover, variable vapor rates, pressure swings, or freeze-prone equipment.',
                    ],
                ],
                [
                    '@type' => 'Question',
                    'name' => 'Where does VaporCommander™ fit?',
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text' => 'VaporCommander™ fits vapor recovery and low-pressure gas capture applications where wet, unstable, or liquid-laden streams make conventional gas-only systems difficult to operate reliably.',
                    ],
                ],
                [
                    '@type' => 'Question',
                    'name' => 'How should operators evaluate fit?',
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text' => 'Operators should review gas volume, liquid behavior, suction and discharge pressure, winter exposure, maintenance history, gas-use options, and the economics of recovered gas value versus installed and lifecycle cost.',
                    ],
                ],
                [
                    '@type' => 'Question',
                    'name' => 'Why mention Fluidstream patents?',
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text' => 'Patent references provide conservative engineering credibility for Fluidstream’s liquid-aware compression approach. They should be viewed as technical support, not as broad legal or competitive claims.',
                    ],
                ],
            ],
        ];
        ...
        $breadcrumbSchema = [
            ...
            'itemListElement' => [
                ...
                [
                    '@type' => 'ListItem',
                    'position' => 3,
                    'name' => 'Methane Emissions Reduction Solutions for Oil & Gas',
                    'item' => $articleUrl,
                ],
            ],
        ];
...
<section class="fs-article-image-hero">
    <style>
        .fs-article-image-hero {
            ...
            color: #ffffff;
            background:
                linear-gradient(100deg, rgba(2, 8, 35, .36) 0%, rgba(2, 8, 35, .28) 42%, rgba(6, 10, 42, 0.2) 72%, rgba(0, 24, 220, 0) 100%),
    ...
    <div class="fs-article-hero-wrap">
        <div>
            ...
            <p class="fs-article-hero-lede">
                Practical vapor recovery and low-pressure gas capture for operators facing tighter methane regulation, wet gas reliability issues, and the need to turn wasted hydrocarbons into recoverable value.
            </p>

            <div class="fs-article-hero-actions">
                <a class="fs-article-hero-btn fs-article-hero-btn-primary" href="/vapor-recovery">
                    Explore VaporCommander™
                </a>
        ...
        <div class="fs-article-hero-card-stack">
            <div class="fs-article-quote-card">
                <strong>
                    Methane reduction succeeds when the field equipment keeps running in real vapor recovery conditions.
                </strong>

                <p>
                    Wet gas, condensate carryover, pressure swings, variable vapor rates, and freeze-prone equipment can determine whether emissions reduction targets are achieved in practice.
                </p>
            </div>
            ...
            <div class="fs-article-mini-grid">
                <div class="fs-article-mini-card">
                    <b>Gas capture</b>
                    <span>Recover vapors that may otherwise be vented, flared, or combusted.</span>
                </div>

                <div class="fs-article-mini-card">
                    <b>Wet gas fit</b>
                    <span>Designed for vapor streams where liquids and instability are present.</span>
                </div>

                <div class="fs-article-mini-card">
                    <b>Regulatory pressure</b>
                    <span>Supports operators facing tightening methane and flaring rules.</span>
                </div>

                <div class="fs-article-mini-card">
                    <b>Field proof</b>
                    <span>Case study: about 500,000 m³/year of gas captured.</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <main id="article" class="article-area py-12 gray">
        ...
        <div class="fs-related-wrap">
            ...
            <div class="fs-related-grid">
                ...
                <div class="fs-related-card">
                    ...
                    <ul class="fs-related-list">
                        <li>
                            <a href="{{ url('/insights/multiphase-vs-conventional-compression') }}">
