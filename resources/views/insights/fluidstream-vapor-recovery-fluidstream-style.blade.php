...
@section('schema')
    @php
        $articleUrl = url('/insights/vapor-recovery-units-oil-gas');

        $techArticleSchema = [
            '@context' => 'https://schema.org',
            '@type' => 'TechArticle',
            'headline' => 'Vapor Recovery Units for Oil & Gas',
            'alternativeHeadline' => 'Engineering Guide to VRU Systems, Failure Modes, and Modern Vapor Recovery Design',
            ...
            'about' => [
                ...
                [
                    '@type' => 'Thing',
                    'name' => 'Oil and gas vapor recovery',
                ],
                [
                    '@type' => 'Thing',
                    'name' => 'Wet vapor reliability',
                ],
                [
                    '@type' => 'Thing',
                    'name' => 'Methane emissions reduction',
                ],
            ],
        ];
        ...
        $faqSchema = [
            ...
            'mainEntity' => [
                [
                    '@type' => 'Question',
                    'name' => 'What does a vapor recovery unit do?',
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text' => 'A VRU captures low-pressure hydrocarbon vapors from tanks or process vessels and compresses them for sales, fuel, gas lift, reinjection, or another beneficial use.',
                    ],
                ],
                [
                    '@type' => 'Question',
                    'name' => 'Why do conventional VRUs fail in wet gas service?',
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text' => 'Many conventional VRUs depend on dry, steady gas. Wet vapor streams can carry condensate, water, foam, or slugs into the compressor, creating shutdowns, contamination, or mechanical damage.',
                    ],
                ],
                [
                    '@type' => 'Question',
                    'name' => 'Why is winter operation difficult for VRUs?',
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text' => 'Water and condensate can freeze in scrubbers, drains, instrument lines, and level controls. This can make separator-dependent VRU systems unstable during cold-weather operation.',
                    ],
                ],
                [
                    '@type' => 'Question',
                    'name' => 'How is multiphase-capable vapor recovery different?',
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text' => 'A multiphase-capable approach is designed to better tolerate entrained liquids and unstable vapor conditions, reducing dependence on perfect upstream separation.',
                    ],
                ],
                [
                    '@type' => 'Question',
                    ...
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text' => 'Operators should review vapor composition, liquid content, flow variability, suction pressure, discharge pressure, winter conditions, maintenance access, and upset scenarios.',
                    ],
                ],
            ],
        ];
        ...
        $breadcrumbSchema = [
            ...
            'itemListElement' => [
                ...
                [
                    '@type' => 'ListItem',
                    'position' => 3,
                    'name' => 'Vapor Recovery Units for Oil & Gas',
                    'item' => $articleUrl,
                ],
            ],
        ];
...
<section class="fs-article-image-hero">
    <style>
        .fs-article-image-hero {
            ...
            color: #ffffff;
            background:
                linear-gradient(100deg, rgba(2, 8, 35, 0.348) 0%, rgba(2, 8, 35, 0.266) 42%, rgba(4, 8, 35, 0.205) 72%, rgba(0, 26, 220, 0) 100%),
        ...
        .fs-article-image-hero::before {
            content: "";
            position: absolute;
            inset: 0;
            z-index: -2;
            /* background:
                radial-gradient(circle at 78% 18%, rgba(21, 209, 255, .22), transparent 30%),
                linear-gradient(90deg, rgba(255, 255, 255, .055) 1px, transparent 1px),
        ...
        .fs-article-image-hero .hero-lede {
            max-width: 760px;
            margin: 0;
            color: rgba(255, 255, 255, .84);
        ...
        .fs-article-image-hero .hero-actions {
            display: flex;
            gap: 1rem;
            flex-wrap: wrap;
            margin-top: 2rem;
        ...
        .fs-article-image-hero .btn:hover {
            transform: translateY(-2px);
            text-decoration: none;
        }

        .fs-article-image-hero .btn-primary {
            background: #0018dc;
            color: #ffffff;
            border-color: #0018dc;
        ...
        .fs-article-image-hero .btn-outline {
            color: #ffffff;
            border-color: rgba(255, 255, 255, .42);
            background: rgba(255, 255, 255, .08);
        }

        .fs-article-image-hero .btn-outline:hover {
            background: rgba(255, 255, 255, .14);
            border-color: rgba(255, 255, 255, .68);
        }

        .fs-article-image-hero .hero-card-stack {
            display: grid;
            gap: 18px;
        }

        .fs-article-image-hero .quote-card,
        .fs-article-image-hero .hero-mini {
            position: relative;
            overflow: hidden;
        ...
        /* .fs-article-image-hero .quote-card::after,
        .fs-article-image-hero .hero-mini::after {
            content: "";
            position: absolute;
            top: 0;
            left: 0;
        ...
        /* .fs-article-image-hero .quote-card:hover,
        .fs-article-image-hero .hero-mini:hover {
            transform: translateY(-3px);
        ...
        .fs-article-image-hero .quote-card:hover::after,
        .fs-article-image-hero .hero-mini:hover::after {
            transform: scaleX(1);
        }

        .fs-article-image-hero .quote-card strong {
            display: block;
            margin-bottom: .7rem;
            color: #ffffff;
            font-size: 1.18rem;
        ...
        .fs-article-image-hero .quote-card p {
            margin-bottom: 0;
            color: rgba(255, 255, 255, .78);
        }

        .fs-article-image-hero .hero-mini-grid {
            display: grid;
            grid-template-columns: repeat(2, 1fr);
            gap: 14px;
        }
        ...
        .fs-article-image-hero .hero-mini b {
            display: block;
            margin-bottom: 6px;
            color: #ffffff;
            font-size: 1.05rem;
        ...
        .fs-article-image-hero .hero-mini span {
            color: rgba(255, 255, 255, .78);
            font-size: .9rem;
            line-height: 1.45;
        }
    ...
    <div class="fs-article-hero-wrap">
        <div>
            ...
            <p class="hero-lede">
                An engineering guide to VRU systems, failure modes, wet vapor reliability, winter operation, and how
                multiphase-capable compression can improve vapor recovery performance in real field conditions.
            </p>
        ...
        <div class="hero-card-stack">
            <div class="quote-card">
                ...
                <p>
                    Tank vapor streams can carry condensate, water, foam, slugs, and rapid pressure changes that expose
                    the limits of conventional VRU designs.
                </p>
            </div>
            ...
            <div class="hero-mini-grid">
                <div class="hero-mini">
                    <b>Wet vapor</b>
                    <span>Designed around liquid carryover risk</span>
                </div>

                <div class="hero-mini">
                    <b>Winter uptime</b>
                    <span>Less dependence on freeze-prone separation</span>
                </div>

                <div class="hero-mini">
                    <b>Emissions value</b>
                    <span>Capture gas that may otherwise be vented or flared</span>
                </div>

                <div class="hero-mini">
                    <b>Technical fit</b>
                    <span>Application review before package selection</span>
                </div>
            </div>
        </div>
    </div>
