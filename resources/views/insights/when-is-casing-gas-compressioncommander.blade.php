    ...
    <section class="fs-article-image-hero">
        <style>
            .fs-article-image-hero {
                ...
                color: #ffffff;
                background:
                    linear-gradient(100deg, rgba(2, 8, 35, .36) 0%, rgba(2, 8, 35, .28) 42%, rgba(6, 9, 34, 0.2) 72%, rgba(0, 24, 220, 0) 100%),
        ...
        <div class="fs-article-hero-wrap">
            <div>
                ...
                <p class="fs-article-hero-lede">
                    A practical guide for evaluating casing gas compression economics, including gas value, oil uplift
                    potential, uptime, wet gas reliability, lifecycle cost, and real field operating conditions.
                </p>
            ...
            <div class="fs-article-hero-card-stack">
                <div class="fs-article-quote-card">
                    ...
                    <p>
                        Oil uplift, gathering pressure, uptime, maintenance burden, wet gas reliability, and installed
                        system complexity can determine whether a casing gas project pays out in the field.
                    </p>
                </div>
        ...
        <div class="wrap cta-inner">
            <div>
                ...
                <div class="cta-actions">
                    <a class="btn-1 btn-primary" href="/technical-review">Request Economic and Technical Review</a>
