...
<header x-data="{
    ...
    <div class="mx-auto max-w-[1680px] px-5 sm:px-6 lg:px-10">
        <div class="grid h-[88px] grid-cols-[auto_1fr_auto] items-center gap-8">

            {{-- Logo --}}
            <div class="shrink-0">
                <a href="{{ url('/') }}" class="flex items-center">
                    <img src="{{ asset('img/logo.png') }}" alt="Fluidstream Logo" class="h-12 w-auto object-contain">
                </a>
            </div>

            {{-- Desktop Nav --}}
            <div class="hidden lg:flex items-center justify-center">
                <nav class="flex items-center gap-8 xl:gap-10">
                    ...
                    <div class="relative" @mouseenter="openMenu('solutions')" @mouseleave="closeMenu('solutions')">
                        <button type="button" @click.prevent="toggleMenu('solutions')"
                            class="nav-link nav-button {{ $solutionsActive ? 'nav-link-active' : '' }}"
                    ...
                    <div class="relative" @mouseenter="openMenu('resources')" @mouseleave="closeMenu('resources')">
                        <button type="button" @click.prevent="toggleMenu('resources')"
                            class="nav-link nav-button {{ $resourcesActive ? 'nav-link-active' : '' }}"
                    ...
                    <a href="{{ url('/patented-technology') }}"
                        class="nav-link {{ $patentedTechnologyActive ? 'nav-link-active' : '' }}">
                        Patented Technology
                    </a>
                </nav>
            </div>
    ...
    {{-- Desktop Applications Mega Menu --}}
