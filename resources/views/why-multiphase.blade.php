...
@section('content')
  <style>
    ...
    header.hero::before {
      ...
      position: absolute;
      inset: 0;
      background: rgba(2, 8, 23, .38) url(/img/Vermilion-5.png);
    ...
    <div class="wrap py-8 sm:py-10 lg:py-20">
      <div class="hero-layout">
        ...
        <aside class="hero-proof-panel">
          ...
          <div class="hero-proof-source-row">
      ...
      <div class="proof-grid">
        ...
        <div class="proof-card interactive-card swipe-left">
          ...
          <div class="proof-card-body">
            ...
            <p>
              ...
              proof that its platform is built for field reality rather than brochure-only assumptions. The
              result shows dependable performance in demanding operating conditions.
            </p>
          </div>
        ...
        <div class="proof-card interactive-card swipe-left">
          ...
          <div class="proof-card-body">
            ...
            <p>
              The most commercially powerful multiphase proof point on the site is the Alberta case where
              Fluidstream helped revive two liquid-loaded wells without adding separation equipment or extra
              site infrastructure, showcasing unmatched efficiency.
            </p>
          </div>
        ...
        <div class="proof-card interactive-card swipe-right">
          ...
          <div class="proof-card-body">
            ...
            <p>
              Severe liquid-influenced multiphase operation is a more demanding proof point than clean-gas
              service. If the technology is stable there, the differentiation argument becomes much stronger
              anywhere liquids create reliability, restart, or maintenance problems.
            </p>
          </div>
  ...
  <section class="section fs-tech-advantage-section">
    <style>
      .fs-tech-advantage-section {
        position: relative;
        overflow: hidden;
        /* background: var(--band, #f4f7fb); */
        border-top: 1px solid #e5edf8;
        border-bottom: 1px solid #e5edf8;
      }

      .fs-tech-advantage-wrap {
        max-width: 1200px;
        margin: 0 auto;
        /* padding: 72px 0; */
      }

      .fs-tech-advantage-head {
        display: grid;
      ...
      .fs-tech-advantage-kicker {
        display: block;
        margin: 0 0 14px;
        color: var(--blue, #0018dc);
        font-size: 13px;
        line-height: 1.2;
        font-weight: 800;
        letter-spacing: .18em;
      ...
      .fs-tech-advantage-summary {
        position: relative;
        overflow: hidden;
        padding: 26px;
        border: 1px solid var(--line, #d9e6ff);
        border-radius: 5px;
        background: #ffffff;
        box-shadow: 0 18px 36px rgba(16, 42, 67, .08);
      ...
      .fs-tech-advantage-summary::after {
        content: "";
        position: absolute;
        inset: 0 0 auto;
        height: 4px;
        background: var(--blue, #0018dc);
        transform: scaleX(0);
        transform-origin: left;
        transition: transform .25s ease;
      }

      .fs-tech-advantage-summary:hover {
        transform: translateY(-3px);
        border-color: var(--blue, #0018dc);
        box-shadow: 0 22px 46px rgba(16, 42, 67, .10);
      }

      .fs-tech-advantage-summary:hover::after {
        transform: scaleX(1);
      }

      .fs-tech-advantage-summary h3 {
        margin: 0 0 12px;
        color: #1f1f21;
        font-size: 24px;
        line-height: 1.12;
      ...
      .fs-tech-advantage-link span {
        font-size: 22px;
        line-height: 1;
        transition: transform .22s ease;
      }

      .fs-tech-advantage-link:hover span {
        transform: translateX(4px);
      }

      .fs-tech-advantage-grid {
        display: grid;
      ...
      .fs-tech-advantage-card {
        ...
        border-radius: 4px;
        background: #ffffff;
        /* box-shadow: 0 18px 36px rgba(16, 42, 67, .06); */
        transition: transform .25s ease, box-shadow .25s ease, border-color .25s ease, background .25s ease;
      }

      .fs-tech-advantage-card::after {
        content: "";
        position: absolute;
        inset: 0 0 auto;
        height: 4px;
      ...
      .fs-tech-advantage-card:hover::after {
        transform: scaleX(1);
      }

      .fs-tech-advantage-card-kicker {
        margin: 0 0 14px;
        color: var(--blue, #0018dc);
        font-size: 12px;
        line-height: 1.2;
      ...
      .fs-tech-advantage-card:hover h3 {
        color: var(--blue, #0018dc);
      }

      .fs-tech-advantage-card p {
        margin: 0;
        color: var(--muted, #475569);
        font-size: 16px;
        line-height: 1.58;
    ...
    <div class="wrap fs-tech-advantage-wrap py-12">
      <div class="fs-tech-advantage-head">
        <div>
          <div class="fs-tech-advantage-kicker">Fluidstream Technology Advantage</div>

          <h2 class="fs-tech-advantage-title">
            Designed for the hardest part of multiphase compression.
          </h2>

          <p class="lead">
            Multiphase compression is not just about accepting liquids. The real advantage is how the system
            responds to liquid-rich, unstable, and changing field conditions while maintaining control,
            containment, and reliability.
          </p>
        </div>

        <aside class="fs-tech-advantage-summary">
          <h3>Direct multiphase compression, refined for real field conditions.</h3>

          <p>
            Fluidstream combines liquid-response methodology, autonomous pressure control, contained gland
            sealing, and seal-condition visibility in a compact multiphase platform.
          </p>

          <a class="fs-tech-advantage-link" href="/technology">
            Explore Fluidstream Technology <span>→</span>
          </a>
        </aside>
      </div>

      <div class="fs-tech-advantage-grid">
        <article class="fs-tech-advantage-card">
          <div class="fs-tech-advantage-card-kicker">Liquid Response</div>
          <h3>Incompressible-liquid handling methodology</h3>
          <p>
            Fluidstream is engineered around liquid-influenced compression behavior, including liquid events
            inside the compression chamber that challenge gas-only compressor assumptions.
          </p>
        </article>

        <article class="fs-tech-advantage-card">
          <div class="fs-tech-advantage-card-kicker">Controls</div>
          <h3>Autonomous target-pressure control</h3>
          <p>
            Operators define a target pressure and the system automatically modulates operation as flow,
            liquid content, slugs, and pressure conditions change.
          </p>
        </article>

        <article class="fs-tech-advantage-card">
          <div class="fs-tech-advantage-card-kicker">Sealing</div>
          <h3>Patent-pending contained gland sealing</h3>
          <p>
            Advanced gland sealing is engineered for contained operation with reduced routine process-fluid
            leakage, reduced operator intervention, and improved site cleanliness.
          </p>
        </article>
  ...
  <style>
    ...
    /* keep existing hover style clean */
    .proof-card:hover .proof-card-bottom {
