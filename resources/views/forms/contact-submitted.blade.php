        ...
        <div class="fs-contact-submitted-wrap">
            <div class="fs-contact-submitted-card">
                ...
                <p class="fs-contact-submitted-lead">
                    Your message has been received. A Fluidstream team member will review your inquiry and follow up through
                ...
                <div class="fs-contact-submitted-note">
                    ...
                    <p>
                        For product questions, technical inquiries, or general business communication, Fluidstream typically
                        responds within 1 to 2 business days.
                    </p>
                </div>
                ...
                <div class="fs-contact-submitted-actions">
                    ...
                    <a href="{{ url('/case-studies') }}"
                        class="fs-contact-submitted-btn fs-contact-submitted-btn-secondary">
                        View Case Studies
                    </a>
