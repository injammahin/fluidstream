        ...
        <div class="fs-review-submitted-wrap">
            <div class="fs-review-submitted-card">
                ...
                <p class="fs-review-submitted-lead">
                    Fluidstream has received your technical review request. Our team will review the submitted operating
                    information and respond through the contact details you provided.
                </p>

                <div class="fs-review-submitted-note">
                    <strong>What happens next?</strong>
                    <p>
                        Fluidstream will review the submitted conditions and may contact you if additional field details are
                        needed. A response is typically provided within 1 to 2 business days.
                    </p>
                </div>
                ...
                <div class="fs-review-submitted-actions">
                    ...
                    <a href="{{ url('/technical-review') }}"
                        class="fs-review-submitted-btn fs-review-submitted-btn-secondary">
