...
@section('content')
  ...
  <section class="hero-tech fs-tech-hero-refined fs-no-watermark">
    <style>
      ...
      .fs-tech-hero-proof-dot {
        ...
        border-radius: 999px;
        background: #ffffff;
        box-shadow: 0 0 0 7px rgba(174, 174, 174, 0.1);
      }
    ...
    <div class="container overview-stage-container">
      ...
      <div class="visual-shell">
        <div class="image-stage" id="overview-stage">
          <img class="fs-no-watermark" src="/img/2270 Rear View.JPG" alt="Fluidstream technology unit" />
          ...
          <button class="hotspot left" data-feature="alignment" style="left:45%;top:50%">
            <span class="hotspot-label-22">Alignment</span>
          </button>
  ...
  <section id="features" class="section contrast">
    <div class="">
      <div class="section-head   container py-12">
        <div>
      ...
      <div class="fs-tech-platform-grid">
        <article id="liquid-response-method" class="fs-tech-platform-card">
          ...
          <div>
            ...
            <div class="fs-patent-note">
              Supported by
              <a href="{{ url('/patented-technology#us11098709b2') }}">
                U.S. Patent No. 11,098,709 B2
              </a>
              for adaptive chamber operation in response to incompressible liquids.
            </div>
            <style>
              .fs-patent-note {
                margin: 22px 0 28px;
