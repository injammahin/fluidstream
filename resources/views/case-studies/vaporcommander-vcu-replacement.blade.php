            ...
            <style>
                .fs-vcu-replacement-image-hero {
                    ...
                    background:
                        ...
                        url("{{ asset('/img/Troxen-VCU-replacement-case-study.png') }}");
                ...
                .fs-vcu-replacement-image-hero::after {
                    content: "";
                    position: absolute;
                    inset: 0;
                    z-index: -1;
                ...
                .fs-vcu-replacement-image-hero .hero-inner {
                ...
                .fs-vcu-replacement-image-hero h1 {
                    max-width: 920px;
                    margin: 0 0 24px;
                    color: #ffffff;
                ...
                .fs-vcu-replacement-image-hero h2 {
                    max-width: 760px;
                    margin: 0 0 18px;
                ...
                .fs-vcu-replacement-image-hero .lead {
                    max-width: 760px;
                    margin: 0;
                    color: rgba(255, 255, 255, .82);
                ...
                .fs-vcu-replacement-image-hero .cta-row {
                    display: flex;
                    gap: 1rem;
                    flex-wrap: wrap;
                    margin-top: 2rem;
                ...
                .fs-vcu-replacement-image-hero .btn {
                    display: inline-flex;
                    align-items: center;
                    justify-content: center;
                    border-radius: 999px;
                ...
                .fs-vcu-replacement-image-hero .btn:hover {
                    transform: translateY(-2px);
                    text-decoration: none;
                }

                .fs-vcu-replacement-image-hero .btn.primary {
                    background: #0018dc;
                    color: #ffffff;
                    border-color: #0018dc;
                ...
                .fs-vcu-replacement-image-hero .btn.secondary {
                    color: #ffffff !important;
                    border-color: rgba(255, 255, 255, .42) !important;
                    background: rgba(255, 255, 255, .08) !important;
                }

                .fs-vcu-replacement-image-hero .btn.secondary:hover {
                    background: rgba(255, 255, 255, .14);
                    border-color: rgba(255, 255, 255, .68);
                }

                .fs-vcu-replacement-image-hero .hero-card.heroo {
                    position: relative;
                    overflow: hidden;
                ...
                /* .fs-vcu-replacement-image-hero .hero-card.heroo::after,
                                .fs-vcu-replacement-image-hero .mini::after {
                                    content: "";
                                    position: absolute;
                                    top: 0;
                                    left: 0;
                ...
                .fs-vcu-replacement-image-hero .hero-card.heroo:hover,
                .fs-vcu-replacement-image-hero .mini:hover {
                    transform: translateY(-3px);
                    border-color: rgba(255, 255, 255, .48) !important;
                    background: rgba(0, 0, 0, .14) !important;
                }

                .fs-vcu-replacement-image-hero .hero-card.heroo:hover::after,
                .fs-vcu-replacement-image-hero .mini:hover::after {
                    transform: scaleX(1);
                }

                .fs-vcu-replacement-image-hero .quote {
                    font-size: 20px;
                    line-height: 1.32;
                    letter-spacing: -.035em;
                    font-weight: 500;
                ...
                .fs-vcu-replacement-image-hero .quote-source-row {
                    display: flex;
                    align-items: center;
                    justify-content: space-between;
                    gap: 18px;
                ...
                .fs-vcu-replacement-image-hero .quote-source {
                    color: rgba(255, 255, 255, .78);
                    font-size: 14px;
                    font-weight: 700;
                }

                .fs-vcu-replacement-image-hero .quote-logo-box {
                    flex: 0 0 150px;
                    width: 150px;
                    height: 80px;
                    display: flex;
                ...
                .fs-vcu-replacement-image-hero .quote-logo-box img {
                    display: block;
                    max-width: 100%;
                    max-height: 80px;
                    width: auto;
                ...
                .fs-vcu-replacement-image-hero .mini-metrics {
                    display: grid;
                    grid-template-columns: repeat(4, 1fr);
                    gap: 10px;
                    margin-top: 22px;
                ...
                .fs-vcu-replacement-image-hero .mini {
                    position: relative;
                    overflow: hidden;
                    border-radius: 7px;
                    background: rgba(0, 0, 0, .08) !important;
                ...
                .fs-vcu-replacement-image-hero .mini strong {
                    display: block;
                    font-size: 22px;
                    letter-spacing: -.04em;
                    color: #ffffff;
                ...
                .fs-vcu-replacement-image-hero .mini span {
                    font-size: 12px;
                    color: rgba(255, 255, 255, .78);
                    font-weight: 800;
                }
        ...
        <section>
            <div class="container">
                ...
                <div class="seo-copy" style="margin-top:34px;max-width:980px">
                    <p class="pb-4">According to the operator’s facilities engineer, the ability to adjust operating
