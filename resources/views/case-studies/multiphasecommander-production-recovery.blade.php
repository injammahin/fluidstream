                ...
                <aside class="hero-card heroo">
                    ...
                    <div class="quote-source-row">
                        ...
                        <div class="quote-logo-box">
                            <img src="{{ asset('/img/Vermilion Energy.png') }}" alt="Allied Energy II Corp. logo">
                        </div>
                    </div>
        ...
        <section class="blue-section py-12 gray">
            <div class="container blue-grid">
                <div>
                    ...
                    <p class="color">Pipeline pressure could rise to about 1200 kPa while the operator wanted the wells
                        exposed to
                        approximately
