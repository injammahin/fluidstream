...
@section('content')
    ...
    <main>
        <section class="fs-whitecap-image-hero fs-protected-bg">
            <style>
                .fs-whitecap-image-hero {
                    position: relative;
                    isolation: isolate;
                    overflow: hidden;
                    min-height: 620px;
                    ...
                    background:
                        ...
                        url("{{ asset('/img/Winter instrument.png') }}");
                ...
                .fs-whitecap-image-hero .hero-inner {
                ...
                .fs-whitecap-image-hero .cta-row {
                    display: flex;
                    gap: 1rem;
                    flex-wrap: wrap;
                    margin-top: 2rem;
                ...
                .fs-whitecap-image-hero .btn:hover {
                    transform: translateY(-2px);
                    text-decoration: none;
                }

                .fs-whitecap-image-hero .btn.primary {
                    background: #0018dc;
                    color: #ffffff;
                    border-color: #0018dc;
                ...
                .fs-whitecap-image-hero .btn.secondary {
                    color: #ffffff !important;
                    border-color: rgba(255, 255, 255, .42) !important;
                    background: rgba(255, 255, 255, .08) !important;
                }

                .fs-whitecap-image-hero .btn.secondary:hover {
                    background: rgba(255, 255, 255, .14);
                    border-color: rgba(255, 255, 255, .68);
                }

                .fs-whitecap-image-hero .hero-card.heroo {
                    position: relative;
                    overflow: hidden;
                ...
                /* .fs-whitecap-image-hero .hero-card.heroo::after,
                                                .fs-whitecap-image-hero .mini::after {
                                                    content: "";
                                                    position: absolute;
                                                    top: 0;
                                                    left: 0;
                ...
                .fs-whitecap-image-hero .hero-card.heroo:hover,
                .fs-whitecap-image-hero .mini:hover {
                    transform: translateY(-3px);
                    border-color: rgba(255, 255, 255, .48) !important;
                    background: rgba(0, 0, 0, .14) !important;
                }

                .fs-whitecap-image-hero .hero-card.heroo:hover::after,
                .fs-whitecap-image-hero .mini:hover::after {
                    transform: scaleX(1);
                }

                .fs-whitecap-image-hero .quote {
                    font-size: 20px;
                    line-height: 1.32;
                    letter-spacing: -.035em;
                    font-weight: 500;
                ...
                .fs-whitecap-image-hero .quote-source-row {
                    display: flex;
                    align-items: center;
                    justify-content: space-between;
                    gap: 18px;
                ...
                .fs-whitecap-image-hero .quote-source-row .quote-source {
                    flex: 1;
                    color: rgba(255, 255, 255, .78);
                    font-size: 14px;
                    font-weight: 800;
                ...
                .fs-whitecap-image-hero .quote-logo-box {
                    flex: 0 0 150px;
                    width: 150px;
                    height: 58px;
                    display: flex;
                ...
                .fs-whitecap-image-hero .quote-logo-box img {
                    display: block;
                    max-width: 100%;
                    max-height: 54px;
                    width: auto;
                ...
                .fs-whitecap-image-hero .mini-metrics {
                    display: grid;
                    grid-template-columns: repeat(4, 1fr);
                    gap: 10px;
                    margin-top: 22px;
                ...
                .fs-whitecap-image-hero .mini strong {
                    display: block;
                    font-size: 22px;
                    letter-spacing: -.04em;
                    color: #ffffff;
                ...
                .fs-whitecap-image-hero .mini span {
                    font-size: 12px;
                    color: rgba(255, 255, 255, .78);
                    font-weight: 800;
                }
                ...
                <div class="result-band">
                    ...
                    <div class="hero-card" style="box-shadow:none">
                        <p class="quote" style="color: #000000">“Based on that performance, we’ve already installed another
                            ...
                            compression.”</p>
                        <div class="quote-source">Facilities Team Lead - East & West SK, Whitecap Resources
                            Inc.</div>
                    </div>
                </div>
            </div>
