...
<section class="bg-[#f5f5f5] py-10 sm:py-12 lg:py-16">
    <div class="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 border-t border-[#cfcfcf] sm:mb-10 lg:mb-12">
            <div class="flex items-stretch overflow-x-auto whitespace-nowrap [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                <button
                    type="button"
                    ...
                    data-tab="case-studies"
                    aria-selected="true">
                    <span class="pointer-events-none absolute left-3 right-3 top-0 h-[5px] bg-[#0b1e8a] sm:left-4 sm:right-4 sm:h-[6px]"></span>
                    Case Studies
                </button>
                ...
                <button
                    ...
                    data-tab="perspectives"
                    aria-selected="false">
                    <span class="pointer-events-none absolute left-3 right-3 top-0 h-[5px] bg-transparent sm:left-4 sm:right-4 sm:h-[6px]"></span>
                    Perspectives
                </button>
            </div>
        </div>
        ...
        <div>
            ...
            <div id="case-studies" class="insights-panel block">
                <div class="mb-8 max-w-[760px] sm:mb-10">
                    <span class="mb-3 inline-block text-[13px] font-semibold uppercase tracking-[0.12em] text-[#0b1e8a]">
                        Insights
                    </span>
                    <h1 class="text-[38px] font-medium leading-[0.98] tracking-[-0.04em] text-[#111111] sm:text-[56px] lg:text-[72px]">
                        Case Studies
                    </h1>
                ...
                <div class="space-y-6 lg:space-y-8">
                    ...
                    <!-- Card 1 -->
                    <article class="overflow-hidden rounded-[24px] border border-[#dbe4f0] bg-white shadow-[0_14px_40px_rgba(0,0,0,0.06)]">
                        <div class="h-[6px] w-full bg-gradient-to-r from-[#0018dc] to-[#15d1ff]"></div>

                        <div class="p-5 sm:p-7 lg:p-8">
                            <div class="mb-4 inline-flex rounded-full bg-[#eaf0ff] px-3 py-2 text-[11px] font-bold uppercase tracking-[0.12em] text-[#0018dc] sm:text-[12px]">
                                Case Study Snapshot
                            </div>

                            <h2 class="mb-4 text-[28px] font-semibold leading-[1.15] tracking-[-0.02em] text-[#0f172a] sm:text-[30px] lg:text-[36px]">
                            ...
                            <blockquote class="mb-6 rounded-r-[16px] border-l-[5px] border-l-[#15d1ff] bg-[#f5fcff] px-5 py-5 text-[16px] leading-[1.7] text-[#0b1b45]">
                                “...eliminated gas venting…
                                <span class="font-bold">100% uptime and no maintenance</span>
                                since installation.”
                            </blockquote>

                            <div class="flex flex-col gap-4 border-t border-[#dbe4f0] pt-5 lg:flex-row lg:items-center lg:justify-between">
                                ...
                                <a href="{{ url('/insights/case-studies/allied-energy-ii-multiphase-vapor-recovery') }}"
                    ...
                    <!-- Card 2 -->
                    <article class="overflow-hidden rounded-[24px] border border-[#dbe4f0] bg-white shadow-[0_18px_45px_rgba(0,24,220,0.10)]">
                        <div class="h-[6px] w-full bg-gradient-to-r from-[#0018dc] to-[#15d1ff]"></div>
                        ...
                        <div class="p-5 sm:p-7 lg:p-8">
                            ...
                            <h2 class="mb-3 text-[28px] font-semibold leading-[1.15] tracking-[-0.02em] text-[#0f172a] sm:text-[30px] lg:text-[36px]">
                            ...
                            <div class="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div class="rounded-[18px] border border-[rgba(19,35,63,0.10)] bg-[linear-gradient(180deg,#ffffff_0%,#f8fcff_100%)] p-4 sm:p-5">
                            ...
                            <blockquote class="mb-6 rounded-r-[16px] border-l-[5px] border-l-[#15d1ff] bg-[#f5fcff] px-5 py-5">
                            ...
                            <div class="flex flex-col gap-4 border-t border-[#dbe4f0] pt-5 lg:flex-row lg:items-center lg:justify-between">
                                ...
                                <a href="{{ url('/insights/case-studies/4-5-years-of-reliable-vapor-recovery') }}"
                                   class="inline-flex w-full items-center justify-center rounded-full bg-gradient-to-r from-[#0018dc] to-[#0d57ea] px-5 py-3 text-[15px] font-bold text-white shadow-[0_10px_22px_rgba(0,24,220,0.18)] transition duration-200 hover:-translate-y-[1px] hover:shadow-[0_14px_28px_rgba(0,24,220,0.24)] sm:w-auto">
                                    Read More
                                </a>
                            </div>
                    ...
                    <article class="overflow-hidden rounded-[24px] border border-[#dbe4f0] bg-white shadow-[0_18px_45px_rgba(0,24,220,0.10)]">
                        ...
                        <div class="p-5 sm:p-7 lg:p-8">
                            ...
                            <div class="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
                                <div class="rounded-[18px] border border-[#dbe5f0] bg-[linear-gradient(180deg,#ffffff_0%,#f8fcff_100%)] p-4 sm:p-5">
                            ...
                            <blockquote class="mb-6 rounded-r-[16px] border-l-[5px] border-l-[#15d1ff] bg-[#f5fcff] px-5 py-5">
                                <p class="text-[16px] leading-[1.7] text-[#0b1b45]">
                                    “Fluidstream’s MultiphaseCommander didn’t just improve performance—it completely transformed two dead wells into revenue-generating assets. We went from zero production to over $1.5 million per year in incremental revenue, without adding any separation equipment or infrastructure.”
                                </p>
                            ...
                            <div class="flex flex-col gap-4 border-t border-[#dbe4f0] pt-5 lg:flex-row lg:items-center lg:justify-between">
                                <div class="text-[14px] leading-[1.5] text-[#475569] lg:max-w-[760px]">
                                    Read the full case study for the operating challenge, deployment details, runtime importance, variable-flow performance, and the broader pad-level opportunity identified by the producer.
                                </div>

                                <a href="{{ url('/insights/case-studies/incremental-revenue-case-study') }}"
                                   class="inline-flex w-full items-center justify-center rounded-full bg-gradient-to-r from-[#0018dc] to-[#0d57ea] px-5 py-3 text-[15px] font-bold text-white shadow-[0_10px_22px_rgba(0,24,220,0.18)] transition duration-200 hover:-translate-y-[1px] hover:shadow-[0_14px_28px_rgba(0,24,220,0.24)] sm:w-auto">
                                    Read More
                                </a>
                            </div>
            ...
            <div id="perspectives" class="insights-panel hidden">
                ...
                <div class="grid grid-cols-1 gap-5 lg:grid-cols-3 lg:gap-6">
                    <article class="rounded-[24px] border border-[#d8d8d8] bg-white p-6 transition duration-200 hover:-translate-y-[2px] hover:shadow-[0_14px_30px_rgba(15,23,42,0.06)] sm:p-7">
                        <span class="mb-4 inline-flex text-[12px] font-semibold uppercase tracking-[0.12em] text-[#0b1e8a]">
                            Perspective
                        </span>
                        ...
                        <p class="text-[16px] leading-[1.8] text-[#4f4f4f]">
                            Why simplified flow-through production models are becoming more important in modern field design.
                        </p>
                        <a href="#"
