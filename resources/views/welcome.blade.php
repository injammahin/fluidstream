...
@section('content')
    ...
    <section class="fs-video-showcase-section">
        <style>
        ...
        <div class="fs-video-showcase-wrap">
            <div class="fs-video-showcase-head section-head">
                ...
                <h2>See Fluidstream technology operating in real field conditions.</h2>

                <p>
                    This video section is optimized to load only when needed, helping keep the page fast while still
                    allowing the video to autoplay, stay muted, and loop continuously.
                </p>
            </div>
