...
@section('content')
    ...
    <style>
        ...
        /* ================================
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   PROOF CARDS: CLEAN TOP-LINE HOVER
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   No blue fill background
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ================================ */
        ...
        /* Remove old blue fill wipe */
        .proof-cards .proof-card::before {
            display: none !important;
            content: none !important;
        }

        /* Add only top blue line */
        .proof-cards .proof-card::after {
            content: "";
            position: absolute;
            left: 0;
            right: 0;
        ...
        .proof-cards .proof-card:hover {
            transform: translateY(-4px);
            border-color: var(--accent-dark, #0018dc) !important;
            background: #ffffff !important;
            box-shadow: 0 24px 54px rgba(16, 42, 67, .12);
        }

        .proof-cards .proof-card:hover::after {
            transform: scaleX(1);
        }

        /* Keep normal colors, do not turn white */
        .proof-cards .proof-card:hover h3 {
            color: var(--accent-dark, #0018dc) !important;
        }

        .proof-cards .proof-card:hover p,
        .proof-cards .proof-card:hover .proof-detail {
            color: var(--muted, #52667a) !important;
        }

        .proof-cards .proof-card:hover .proof-metric {
            color: var(--accent-dark, #0018dc) !important;
            border-top-color: rgba(16, 42, 67, .10) !important;
        }

        .proof-cards .proof-card:hover .proof-tag {
            background: #edf3ff !important;
            border-color: #bcd0ff !important;
            color: var(--accent-dark, #0018dc) !important;
        }

        .proof-cards .proof-card:hover .proof-view-link,
        .proof-cards .proof-card:hover .proof-view-link * {
            color: var(--accent-dark, #0018dc) !important;
        }
    ...
    <section class="fs-home-hero fs-no-watermark" aria-labelledby="home-hero-title">
        ...
        <div class="fs-home-hero-inner">
            <div class="fs-home-hero-copy">
                ...
                <p class="fs-home-hero-lead">
                    Multiphase compression systems designed for real oilfield conditions, handling 100% liquid, 100% gas, or
                    any liquid–gas mixture.
                </p>

                <p class="fs-home-hero-support">
                    Built for wet gas, liquids, slugs, freezing, and unstable flow—conditions where conventional compression
                    struggles.
                </p>
                ...
                <div class="fs-home-metric-grid">
                    ...
                    <div class="fs-home-metric-card">
                        ...
                        <span>1.5 years in active VRU service with no maintenance required since installation</span>
                    </div>
            ...
            <aside class="fs-home-proof-card fs-home-quote-card" aria-label="Cycling field proof quotes">
                ...
                <div class="fs-home-quote-stage">
                    <article class="fs-home-quote-slide active">
                        <div class="fs-home-quote-content">
                            ...
                            <p class="fs-home-quote-text">
                                “Since installation, Fluidstream’s VaporCommander™ has maintained <strong class="bold">100%
                                    uptime for
                                    over
                                    1.5
                                    years</strong> while eliminating gas venting from our tanks, without requiring
                                maintenance or
                        ...
                        <div class="fs-home-quote-footer">
                            <span class="fs-home-quote-source">
                                VP Production,<br /> Allied Energy II Corp.
                            </span>
                    ...
                    <article class="fs-home-quote-slide">
                        <div class="fs-home-quote-content">
                            <p class="fs-home-quote-text">
                                “It handles real-world multiphase conditions … <strong class="bold">zero seal leakage, no
                                    maintenance,</strong> and no
                                operational headaches to date. <br><br>
                                This is the first solution we’ve seen that delivers both simplicity and reliable
                                performance.”
                            </p>
                        </div>
                        ...
                        <div class="fs-home-quote-footer">
                            <span class="fs-home-quote-source">
                                Production Engineer,<br /> Vermilion Energy Inc.
                            </span>
                    ...
                    <article class="fs-home-quote-slide">
                        <div class="fs-home-quote-content">
                            ...
                            <p class="fs-home-quote-text">
                                ...
                                and no need for intervention. Maintenance has been minimal, with only a quick filter
                                change.”
                            </p>
                        </div>
                        ...
                        <div class="fs-home-quote-footer">
                            ...
                            {{-- <div class="fs-home-quote-logo-box">
                                <img src="{{ asset('/img/whitecapLogo.png') }}" alt="Whitecap Resources Inc. logo"
            ...
            <div class="proof-cards">
                <article class="proof-card">
                    ...
                    <div class="proof-detail">
                        1.5+ years • 0 maintenance • operated through 2 winters below −40°C • gas venting eliminated
                    </div>
    ...
    <section class="fs-video-showcase-section py-12">
        <style>
            .fs-video-showcase-section {
                /* padding: 72px 0; */
                background: #f6f7fb;
            ...
            .fs-video-showcase-wrap {
                width: min(1200px, calc(100% - 40px));
                margin: 0 auto;
            }

            .fs-video-showcase-head {
                margin-bottom: 32px;
            }

            /* .fs-video-showcase-head h2 {
                                                                                                                                                                                                                                                                                max-width: 760px;
                                                                                                                                                                                                                                                                                margin: 0 0 14px;
                                                                                                                                                                                                                                                                                color: #102a43;
                                                                                                                                                                                                                                                                                font-size: clamp(1.9rem, 3vw, 3rem);
            ...
            .fs-video-showcase-card:hover::after {
                transform: scaleX(1);
            }

            .fs-video-showcase-media {
                position: relative;
                aspect-ratio: 16 / 9;
                min-height: 420px;
                background: #07111f;
            ...
            .fs-video-showcase-overlay {
                position: absolute;
                inset: 0;
                pointer-events: none;
                background:
                    linear-gradient(90deg, rgba(2, 6, 23, .42) 0%, rgba(2, 6, 23, .12) 48%, rgba(2, 6, 23, .05) 100%),
                    linear-gradient(180deg, rgba(2, 6, 23, .08) 0%, rgba(2, 6, 23, .32) 100%);
            }

            .fs-video-showcase-badge {
                position: absolute;
                left: 22px;
                top: 22px;
                z-index: 2;
        ...
        <div class="fs-video-showcase-wrap">
            <div class="fs-video-showcase-head section-head">
                ...
                <p>
                    Fluidstream is designed to reduce facility complexity by handling multiphase production directly through
                    a compact compression platform.
                </p>
            </div>

            <div class="fs-video-showcase-card">
                <div class="fs-video-showcase-media">
                    {{-- <span class="fs-video-showcase-badge">Continuous playback</span> --}}

                    <video class="fs-lazy-video fs-protected-media" muted loop playsinline preload="none"
                        poster="{{ asset('img/video-poster.jpg') }}" data-src="{{ asset('/video/3d video.mp4') }}"
                        controlsList="nodownload noplaybackrate noremoteplayback" disablePictureInPicture
                        disableRemotePlayback draggable="false" oncontextmenu="return false;">
                    </video>

                    <span class="fs-media-shield" aria-hidden="true"></span>

                    {{-- <div class="fs-video-showcase-overlay"></div> --}}
                </div>

                {{-- <div class="fs-video-showcase-caption">
                    <div>
                        <h3>Multiphase compression in motion.</h3>

                        <p>
                            Use this area to show field operation, product behavior, installation footage, or a short
                            technical demonstration without slowing the initial page load.
                        </p>
                    </div>

                    <span class="fs-video-showcase-status">Muted autoplay loop</span>
                </div> --}}
            </div>
        </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                const videos = document.querySelectorAll('.fs-lazy-video');
    ...
    <section class="section fs-platform-capability-section" aria-labelledby="platform-capability-title">
        ...
        <div class="fs-platform-capability-wrap py-12">
